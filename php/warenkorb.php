...
<head>
    ...
    <title>Getränke Shop Warenkorb</title>
...
<body>
                ...
                <div class="container py-5">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between total font-weight-bold mt-4">
                            <form action="WarenkorbAendern.php" method="post">
                                <span>Menge: <input required type="number" min="0" id="amount" name="amount"value="'.$row['Menge'].'"><br></span>

                                <input type="hidden" id="artikelID" name="artikelID" value="'.$row['ArtikelID'].'">
                                
                                <span><input type="submit" value="Menge Ändern"></span>
    ...
    echo'
        ...
        <div  class="centered">
            ...
            <span><button onclick="location.href=`kasse.php`">Zur Kasse</button></span>
